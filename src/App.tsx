  ...
  useEffect(() => {
    ...
    try {
      ...
      if (installed) {
        ...
        const u = MiniKit.username || null;
        if (u) {
          setUsername(u);
          localStorage.setItem("username", u);
          console.log("[APP] Username detectado al inicio:", u);
        }
      } else {
